        ...
        <div class="bianjiqi_box">
          <ul class="b_list">
            ...
            <li class="clearfix"><span class="l">正文</span>
              <quill-editor class="edit-tools" v-model="content"
                ref="myQuillEditor"
            ...
            <li><span class="l">封面</span>
              <label for="cover-one">
                <i class="danxuan">
                  <input type="radio" name="cover" id="cover-one" value="0" v-model="frontcover">
                单图</i>
              </label>
              <i class="tishi">封面限5M，请上传于文章内容有关的封面</i>
              <div class="shangchuan">
                <p v-show="isOne"  @click="outerVisible = true"></p>
                <p v-show="isThree"  @click="outerVisible = true"></p>
                <p v-show="isThree"  @click="outerVisible = true"></p>
              </div>
            </li>
            ...
            <li class="settings">
              ...
              <div class="settings-box">
                <div class="settings-subbox">
                  <label for="settings-advert">
                    <input type="checkbox" name="" id="settings-advert"> 显示广告卡片
                  </label>
                </div>
                <div class="settings-subbox">
                  <label for="settings-weixin">
                   <input type="checkbox" name="" id="settings-weixin"> 推广我的微信公众号
                  </label>
                </div>
                <div class="settings-subbox">
                  <label for="settings-settime">
                   <input type="checkbox" name="" id="settings-settime"> 定时发送
                  </label>
                </div>
              </div>
            </li>
            <li class="btn2"><a @click="previewStatus = true">发布</a></li>
          </ul>
        </div>
      </div>
</template>
